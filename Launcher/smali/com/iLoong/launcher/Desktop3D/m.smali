.class Lcom/iLoong/launcher/Desktop3D/m;
...
.field private final synthetic e:Landroid/appwidget/AppWidgetManager;


# direct methods
.method constructor <init>(Lcom/iLoong/launcher/Desktop3D/g;Lcom/iLoong/launcher/UI3DEngine/ViewGroup3D;Ljava/util/HashSet;Ljava/util/ArrayList;Landroid/appwidget/AppWidgetManager;)V
    .locals 0

    iput-object p1, p0, Lcom/iLoong/launcher/Desktop3D/m;->a:Lcom/iLoong/launcher/Desktop3D/g;

    iput-object p2, p0, Lcom/iLoong/launcher/Desktop3D/m;->b:Lcom/iLoong/launcher/UI3DEngine/ViewGroup3D;

    iput-object p3, p0, Lcom/iLoong/launcher/Desktop3D/m;->c:Ljava/util/HashSet;

    iput-object p4, p0, Lcom/iLoong/launcher/Desktop3D/m;->d:Ljava/util/ArrayList;

    iput-object p5, p0, Lcom/iLoong/launcher/Desktop3D/m;->e:Landroid/appwidget/AppWidgetManager;
...
.method public run()V
    ...
    iget-object v0, p0, Lcom/iLoong/launcher/Desktop3D/m;->b:Lcom/iLoong/launcher/UI3DEngine/ViewGroup3D;
    ...
    iget-object v2, p0, Lcom/iLoong/launcher/Desktop3D/m;->c:Ljava/util/HashSet;
    ...
    :cond_4
    instance-of v2, v1, Lcom/iLoong/launcher/a/h;

    if-eqz v2, :cond_5

    iget-object v1, p0, Lcom/iLoong/launcher/Desktop3D/m;->a:Lcom/iLoong/launcher/Desktop3D/g;

    check-cast v0, Lcom/iLoong/launcher/d/a;

    iget-object v2, p0, Lcom/iLoong/launcher/Desktop3D/m;->d:Ljava/util/ArrayList;
    ...
    :cond_5
    instance-of v2, v1, Lcom/iLoong/launcher/a/c;

    if-eqz v2, :cond_1

    check-cast v1, Lcom/iLoong/launcher/a/c;

    iget-object v2, p0, Lcom/iLoong/launcher/Desktop3D/m;->e:Landroid/appwidget/AppWidgetManager;

    iget v7, v1, Lcom/iLoong/launcher/a/c;->a:I

    invoke-virtual {v2, v7}, Landroid/appwidget/AppWidgetManager;->getAppWidgetInfo(I)Landroid/appwidget/AppWidgetProviderInfo;
    ...
    iget-object v3, p0, Lcom/iLoong/launcher/Desktop3D/m;->a:Lcom/iLoong/launcher/Desktop3D/g;
