...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v1, p0, Lcom/android/server/MountService;->usbStatePath:Ljava/lang/String;
    ...
    iput-object v1, p0, Lcom/android/server/MountService;->targeting_asec_path:Ljava/lang/String;
...
.method static synthetic access$1600(Lcom/android/server/MountService;)Lcom/android/internal/app/IMediaContainerService;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$1602(Lcom/android/server/MountService;Lcom/android/internal/app/IMediaContainerService;)Lcom/android/internal/app/IMediaContainerService;
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$1700(Lcom/android/server/MountService;)Ljava/util/Map;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$1900(Lcom/android/server/MountService;Lcom/android/server/MountService$ObbState;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$2000(Lcom/android/server/MountService;)Lcom/android/server/MountService$DefaultContainerConnection;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$2400(Lcom/android/server/MountService;Ljava/lang/String;I)Z
    .locals 1
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method private doGetVolumeShared(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .line 1053
    invoke-direct {p0}, Lcom/android/server/MountService;->getUsbCableConnection()Z
    ...
    const-string v9, "Disabling UMS after cable disconnect"
...
.method private doMountVolume(Ljava/lang/String;)I
    ...
    const-string v5, "doMountVolume: Mouting "
...
.method private getUsbCableConnection()Z
    .locals 5
    ...
    .line 1372
    .local v0, usbConnection:Z
    const-string v2, "/sys/devices/virtual/switch/usb_mass_storage/state"

    invoke-direct {p0, v2}, Lcom/android/server/MountService;->getStateFromFile(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v4, "getUsbCableConnection :: usbState = "
...
.method private notifyShareAvailabilityChange(Ljava/lang/String;Z)V
    ...
    const-string v6, "### notifyShareAvailabilityChange :: method = "
    ...
    const-string v5, "notifyShareAvailabilityChange :: send ACTION_UMS_CONNECTED"
...
.method private notifyVolumeStateChange(Ljava/lang/String;Ljava/lang/String;II)V
    ...
    const-string v4, "notifyVolumeStateChange ::"
    ...
    const-string v3, "Sending intent :: ACTION_MEDIA_UNSHARED "
    ...
    const-string v3, "Sending intent :: ACTION_MEDIA_SHARED "
...
.method private updatePublicVolumeState(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v6, "@@@@@@ updatePublicVolumeState :: path = "
    ...
    const-string v5, "mPms.updateExternalMediaStatus(false, false)"
    ...
    invoke-virtual {v5, v9, v9}, Lcom/android/server/PackageManagerService;->updateExternalMediaStatus(ZZ)V
    ...
    const-string v5, "mPms.updateExternalMediaStatus(ture, false)"
    ...
    invoke-virtual {v5, v10, v9}, Lcom/android/server/PackageManagerService;->updateExternalMediaStatus(ZZ)V
...
.method public getSecureContainerList()[Ljava/lang/String;
    ...
    .line 1485
    :try_start_0
    invoke-virtual {p0}, Lcom/android/server/MountService;->isASECMounted()Z
...
.method public getSecureContainerPath(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lcom/android/server/MountService;->getASECMountPath()Ljava/lang/String;
...
.method public getStorageUsers(Ljava/lang/String;)[I
    ...
    const-string v7, "getStorageUsers :: Error parsing pid %s"
    ...
    const-string v6, "getStorageUsers :: Failed to retrieve storage users list"
...
.method public onEvent(ILjava/lang/String;[Ljava/lang/String;)Z
    ...
    const-string v20, "Sending intent: Intent.ACTION_ADB_ENABLED_BY_KIES_MODE"
    ...
    .end local v12           #in:Landroid/content/Intent;
    const-string v19, "android.intent.action.ADB_ENABLED_BY_KIES_MODE"
