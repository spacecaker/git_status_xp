...
PRODUCT_COPY_FILES += \
    ...
    device/samsung/cooper/files/usr/keylayout/sec_touchscreen.kl:system/usr/keylayout/sec_touchscreen.kl

# fstab
PRODUCT_COPY_FILES += \
    device/samsung/cooper/files/etc/vold.fstab:system/etc/vold.fstab

# Init
PRODUCT_COPY_FILES += \
    device/samsung/cooper/files/init.gt-s5830.rc:root/init.gt-s5830.rc \
    device/samsung/cooper/files/ueventd.gt-s5830.rc:root/ueventd.gt-s5830.rc \
	device/samsung/cooper/files/bin/abtfilt:system/bin/abtfilt \
	device/samsung/cooper/files/bin/get_macaddrs:system/bin/get_macaddrs \
	device/samsung/cooper/files/etc/init.d/02cooper:system/etc/init.d/02cooper

# Audio
PRODUCT_COPY_FILES += \
    device/samsung/cooper/files/etc/AudioFilter.csv:system/etc/AudioFilter.csv \
    device/samsung/cooper/files/etc/AutoVolumeControl.txt:system/etc/AutoVolumeControl.txt

# WLAN + BT
PRODUCT_COPY_FILES += \
    device/samsung/cooper/files/etc/wifi/wpa_supplicant.conf:system/etc/wifi/wpa_supplicant.conf \
    device/samsung/cooper/files/etc/dhcpcd/dhcpcd.conf:system/etc/dhcpcd/dhcpcd.conf \
    device/samsung/cooper/files/bin/hostapd:system/bin/hostapd \
    device/samsung/cooper/files/etc/wifi/hostapd.conf:system/etc/wifi/hostapd.conf
...
#Media profile
PRODUCT_COPY_FILES += \
    device/samsung/cooper/files/etc/media_profiles.xml:system/etc/media_profiles.xml
