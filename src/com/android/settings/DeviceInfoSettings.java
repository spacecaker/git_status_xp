...
public class DeviceInfoSettings extends SettingsPreferenceFragment {
    ...
    private static final String KEY_MSR_VERSION = "msr_version";
    ...
    public void onCreate(Bundle icicle) {
        ...
        setStringSummary(KEY_MSR_VERSION, Build.MODEL);
        ...
        if (preference.getKey().equals(KEY_MOD_VERSION)) {
            ...
            if (mHits[0] >= (SystemClock.uptimeMillis()-500)) {
                ...
                intent.setClassName("com.android.settings",
                        com.android.settings.kitkat.PlatLogoActivity.class.getName());
                try {
                    startActivity(intent);
                } catch (Exception e) {
                    Log.e(LOG_TAG, "Unable to start activity " + intent.toString());
